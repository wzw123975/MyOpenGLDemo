...
import com.wzw.myopengldemo.R;
import com.wzw.myopengldemo.one.utils.ResReadUtils;
import com.wzw.myopengldemo.one.utils.ShaderUtils;
 ...
 * @description:
 */
public class TwoRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        GLES30.glEnableVertexAttribArray(0);//启用顶点属性

        vertexBuffer.position(VERTEX_POSITION_SIZE);//定位本地内存的位置
